...
from metabci.brainda.algorithms.deep_learning.simple_vit import SimpleViT
...
estimator = SimpleViT(image_size=(1, X.shape[1]), patch_size=(1, 1), num_classes=2, dim=20,
                      depth=2, heads=4, mlp_dim=40,
                      channels=X.shape[2], dim_head=64)
