...
from metabci.brainda.algorithms.deep_learning.conformer import Conformer
...
estimator = Conformer(num_channels=X.shape[1], n_samples=X.shape[2], emb_size=128, depth=1, num_heads=2, n_classes=2)
